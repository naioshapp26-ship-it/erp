/**
 * 🧪 Test Plan Installments API Endpoints
 */
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                total_installments: data.summary?.total_installments,
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - أقساط خطط السداد');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/plan-installments/test`
    );
    ...
    const test2 = await testAPI(
        '2️⃣ Get Plan Installments Report',
        `${BASE_URL}/finance/plan-installments?entity_id=${ENTITY_ID}`
    );
