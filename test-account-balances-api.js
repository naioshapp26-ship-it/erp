/**
 * 🧪 Test Account Balances API Endpoints
 */
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - أرصدة الحسابات');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/account-balances/test`
    );
    ...
    const test2 = await testAPI(
        '2️⃣ Get Account Balances Report',
        `${BASE_URL}/finance/account-balances?entity_id=${ENTITY_ID}`
    );
