/**
 * 🧪 Test Journal Lines API Endpoints
 */
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                total_debit: data.summary?.total_debit,
                total_credit: data.summary?.total_credit,
                total_diff: data.summary?.total_diff
            });
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - تفاصيل القيود');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/journal-lines/test`
    );
    ...
    const test2 = await testAPI(
        '2️⃣ Get Journal Lines',
        `${BASE_URL}/finance/journal-lines?entity_id=${ENTITY_ID}`
    );
