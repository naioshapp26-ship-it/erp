(function () {
  ...
  const STORAGE_PREFIX = 'platforms:data:v2:';
  ...
  function renderRowActions(route, index) {
    if (window.EntityHierarchyUI?.renderHubRowActions) {
      return window.EntityHierarchyUI.renderHubRowActions('pl', route, index);
    }
    return `
