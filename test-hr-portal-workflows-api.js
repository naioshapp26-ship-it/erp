...
async function testHrPortalWorkflowsAPI() {
    console.log('🧪 اختبار واجهات بوابة العمليات والطلبات\n');
    ...
    if (passedTests === tests.length) {
        console.log('🎉 جميع اختبارات بوابة العمليات والطلبات نجحت!\n');
        process.exit(0);
    } else {
