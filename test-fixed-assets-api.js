/**
 * 🧪 Test Fixed Assets API Endpoints
 */
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                total_depreciations: data.summary?.depreciation?.total_depreciations
            });
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - الأصول الثابتة والإهلاك');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/fixed-assets/test`
    );
    ...
    const test2 = await testAPI(
        '2️⃣ Get Fixed Assets Report',
        `${BASE_URL}/finance/fixed-assets?entity_id=${ENTITY_ID}`
    );
