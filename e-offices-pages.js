(function () {
  ...
  function normalizeRecords(route, records) {
    ...
    if (config?.hierarchyLayout && window.EntityHierarchyUI?.normalizeRows) {
      const cellRows = normalized.map((record) => getRowCells(record));
      const normalizedCells = window.EntityHierarchyUI.normalizeRows(cellRows, config);
      return normalized.map((record, index) => ({
        ...record,
        cells: normalizedCells[index] || getRowCells(record)
      }));
    }
    return normalized;
  }
  ...
  async function replenishModuleIfSparse(route, config) {
    const seedRows = config.customerProfile === 'customer-service' && window.EntityHierarchyUI
      ? window.EntityHierarchyUI.getCustomerServiceSeed()
      : (config.seed || []).slice();
    if (!seedRows.length) return;
    await apiRequest(route, {
      method: 'POST',
      suffix: '/replenish',
      body: { seed: seedRows, minimum: SEED_MINIMUM }
    });
  }
  ...
  const PAGE_CONFIGS = {
    'eo-daily-operations': {
      ...
      seed: [
        ...
        ['متابعة شكاوى العملاء', 'خدمة العملاء', 'قيد التنفيذ', '2026-06-08'],
        ['تحديث لوحة المؤشرات', 'محلل البيانات', 'مكتمل', '2026-06-08'],
        ['تنسيق زيارة ميدانية', 'مشرف الفروع', 'مجدول', '2026-06-10'],
        ['إغلاق مهام الأمس', 'منسق التشغيل', 'مكتمل', '2026-06-08'],
        ['تفعيل حسابات جديدة', 'فريق الدعم', 'قيد التنفيذ', '2026-06-09'],
        ['مراجعة عقود الموردين', 'المشتريات', 'عاجلة', '2026-06-09'],
        ['إعداد ملخص نهاية اليوم', 'مدير المكتب', 'مجدول', '2026-06-09']
      ]
    },
    'eo-sales': {
      title: 'المبيعات',
      ...
      seed: [
        ...
        ['2110', 'مصنع الخليج', 'procurement@gulf-mfg.sa', '+966502110333', 'فرع الدمام', 'حاضنة الشرقية', 'منصة الشرقية', 'مكتب الدمام', '156,000 ر.س', 'تفاوض', '2026-06-09'],
        ['2122', 'أكاديمية المستقبل', 'training@future-ac.sa', '+966502122444', 'فرع الرياض', 'حاضنة الرياض', 'منصة الرياض', 'مكتب التدريب', '32,800 ر.س', 'عرض مرسل', '2026-06-06'],
        ['2133', 'مستشفى النور', 'it@alnoor-hosp.sa', '+966502133555', 'فرع جدة', 'Safety Incubator', 'NAIOSH Cloud', 'مكتب جدة', '210,500 ر.س', 'قيد المتابعة', '2026-06-04'],
        ['2144', 'شركة النقل السريع', 'ops@fastlog.sa', '+966502144666', 'فرع الدمام', '—', '—', 'مكتب اللوجستيات', '67,200 ر.س', 'مغلقة', '2026-06-02'],
        ['2155', 'مجمع الأعمال الرقمي', 'ceo@dba-hub.sa', '+966502155777', 'فرع الرياض', 'حاضنة الرياض التقنية', 'منصة الرياض', 'مكتب المبيعات', '128,900 ر.س', 'تفاوض', '2026-06-09'],
        ['2166', 'مؤسسة البناء الحديث', 'contracts@modern-build.sa', '+966502166888', 'فرع جدة', 'حاضنة جدة', 'منصة جدة', 'مكتب جدة', '84,300 ر.س', 'عرض مرسل', '2026-06-03'],
        ['2177', 'تجمع الصحة الرقمية', 'sales@health-dx.sa', '+966502177999', 'المكتب الرئيسي', '—', '—', 'المكتب الرئيسي', '305,000 ر.س', 'قيد المتابعة', '2026-06-01']
      ]
    },
    'eo-subscriptions': {
      title: 'الاشتراكات',
      ...
      seed: [
        ...
        ['فرع الرياض', 'حاضنة الرياض', 'منصة الرياض', 'شركة المدار', 'PRO', 'نشط', '2026-10-20'],
        ['فرع جدة', 'حاضنة جدة', 'منصة جدة', 'مستشفى النور', 'ENTERPRISE', 'نشط', '2026-11-05'],
        ['فرع الشرقية', 'حاضنة الشرقية', 'منصة الشرقية', 'مصنع الخليج', 'PRO', 'نشط', '2026-08-30'],
        ['فرع الرياض', 'حاضنة الرياض التقنية', 'منصة الرياض', 'أكاديمية المستقبل', 'BASIC', 'منتهي', '2026-05-01'],
        ['فرع جدة', 'Safety Incubator', 'NAIOSH Cloud', 'شركة النقل السريع', 'PRO', 'نشط', '2026-06-15'],
        ['المكتب الرئيسي', '—', '—', 'تجمع الصحة الرقمية', 'ENTERPRISE', 'نشط', '2027-01-01']
      ]
    },
    'eo-training': {
      title: 'التدريب',
      ...
      seed: [
        ...
        ['القيادة الإدارية', 'د. فهد العتيبي', '16', 'جارية'],
        ['أمن المعلومات', 'م. خالد السبيعي', '20', 'مجدولة'],
        ['إدارة المشاريع', 'أ. منى الحربي', '14', 'مكتملة'],
        ['التواصل المؤسسي', 'فريق التسويق', '22', 'جارية'],
        ['الجودة والامتثال', 'د. نايف القحطاني', '10', 'مجدولة'],
        ['مهارات العرض', 'أ. سارة الغامدي', '28', 'جارية'],
        ['إدارة الوقت', 'فريق التطوير', '15', 'مكتملة']
      ]
    },
    'eo-customer-service': {
      title: 'خدمة العملاء',
      ...
      seed: [
        ...
        ['4420', 'مصنع الخليج', 'support@gulf-mfg.sa', '+966504420333', 'فرع الدمام', 'حاضنة الشرقية', 'منصة الشرقية', 'مكتب الدمام', 'دعم فني', 'فريق الدعم', '2026-06-09', 'عالية', 'تعطل في التكامل', 'قيد المعالجة', '2026-06-12'],
        ['5531', 'أكاديمية المستقبل', 'help@future-ac.sa', '+966505531444', 'فرع الرياض', 'حاضنة الرياض', 'منصة الرياض', 'مكتب الرياض', 'ترقية خطة', 'أ. سارة', '2026-06-08', 'متوسطة', 'طلب ترقية PRO', 'قيد المعالجة', '2026-06-14'],
        ['6642', 'مستشفى النور', 'billing@alnoor-hosp.sa', '+966506642555', 'فرع جدة', 'Safety Incubator', 'NAIOSH Cloud', 'مكتب جدة', 'فوترة', 'فريق المالية', '2026-06-06', 'عالية', 'خطأ في الفاتورة', 'تم الرد', '2026-06-09'],
        ['7753', 'شركة النقل السريع', 'ops@fastlog.sa', '+966507753666', 'فرع الدمام', '—', '—', 'مكتب اللوجستيات', 'تدريب', 'فريق التدريب', '2026-06-04', 'منخفضة', 'تدريب مستخدمين', 'مغلقة', '2026-06-07'],
        ['8864', 'مجمع الأعمال الرقمي', 'ceo@dba-hub.sa', '+966508864777', 'فرع الرياض', 'حاضنة الرياض التقنية', 'منصة الرياض', 'مكتب المبيعات', 'تفعيل حساب', 'فريق الدعم', '2026-06-09', 'عالية', 'تفعيل 15 مستخدم', 'قيد المعالجة', '2026-06-11'],
        ['9975', 'مؤسسة البناء الحديث', 'contracts@modern-build.sa', '+966509975888', 'فرع جدة', 'حاضنة جدة', 'منصة جدة', 'مكتب جدة', 'استفسار', 'أ. نورة', '2026-06-03', 'متوسطة', 'سؤال عن التجديد', 'تم الرد', '2026-06-05'],
        ['1086', 'تجمع الصحة الرقمية', 'sales@health-dx.sa', '+966501086999', 'المكتب الرئيسي', '—', '—', 'المكتب الرئيسي', 'دعم فني', 'فريق الدعم', '2026-06-02', 'عالية', 'مشكلة في API', 'قيد المعالجة', '2026-06-08']
      ]
    },
    'eo-operational-reports': {
      ...
      seed: [
        ...
        ['تقرير رضا العملاء', 'مايو 2026', 'خدمة العملاء', 'منشور'],
        ['مؤشرات الحضور', 'يونيو 2026', 'الموارد البشرية', 'قيد الإعداد'],
        ['تقرير الاشتراكات', 'Q2 2026', 'إدارة الاشتراكات', 'منشور'],
        ['تحليل الأداء المالي', 'يونيو 2026', 'المالية', 'بانتظار الاعتماد'],
        ['تقرير المشاريع النشطة', 'الأسبوع 23', 'إدارة المشاريع', 'قيد الإعداد'],
        ['مؤشرات التدريب', 'Q2 2026', 'التدريب', 'منشور'],
        ['تقرير المخاطر التشغيلية', 'يونيو 2026', 'إدارة المخاطر', 'بانتظار الاعتماد']
      ]
    },
    'eo-local-hr': {
      ...
      seed: [
        ...
        ['1004', 'نورة الدوسري', 'noura@naiosh.com', '+966501004004', 'فرع الرياض', 'حاضنة الرياض التقنية', 'منصة الرياض', 'مكتب الرياض', 'الموارد البشرية', 'أخصائي', 'نشط'],
        ['1005', 'خالد المطيري', 'khaled@naiosh.com', '+966501005005', 'فرع جدة', 'حاضنة جدة', 'منصة جدة', 'مكتب جدة', 'المالية', 'محاسب', 'نشط'],
        ['1006', 'منى الحربي', 'mona@naiosh.com', '+966501006006', 'فرع الدمام', 'حاضنة الشرقية', 'منصة الشرقية', 'مكتب الدمام', 'التدريب', 'منسق', 'نشط'],
        ['1007', 'فهد العتيبي', 'fahad@naiosh.com', '+966501007007', 'المكتب الرئيسي', '—', '—', 'المكتب الرئيسي', 'الإدارة', 'مدير', 'نشط'],
        ['1008', 'ريم السبيعي', 'reem@naiosh.com', '+966501008008', 'فرع الرياض', 'حاضنة الرياض', 'منصة الرياض', 'مكتب المبيعات', 'المبيعات', 'موظف', 'إجازة'],
        ['1009', 'عبدالله الغامدي', 'abdullah@naiosh.com', '+966501009009', 'فرع جدة', 'Safety Incubator', 'NAIOSH Cloud', 'مكتب الدعم', 'الدعم', 'مشرف', 'نشط'],
        ['1010', 'هند الزهراني', 'hind@naiosh.com', '+966501010010', 'فرع الدمام', '—', '—', 'مكتب اللوجستيات', 'العمليات', 'موظف', 'نشط']
      ]
    },
    'eo-operational-finance': {
      ...
      seed: [
        ...
        ['ترخيص برمجيات', '24,600 ر.س', 'محصل', '2026-06-03'],
        ['تدريب موظفين', '9,800 ر.س', 'معتمد', '2026-06-06'],
        ['استضافة سحابية', '36,000 ر.س', 'قيد الدفع', '2026-06-08'],
        ['تسويق رقمي', '12,500 ر.س', 'محصل', '2026-06-02'],
        ['صيانة مرافق', '6,750 ر.س', 'متأخر', '2026-05-28'],
        ['اشتراك دعم فني', '18,000 ر.س', 'محصل', '2026-06-04'],
        ['توريد أجهزة', '42,300 ر.س', 'قيد الدفع', '2026-06-09']
      ]
    },
    'eo-files': {
      title: 'الملفات',
      ...
      seed: [
        ...
        ['هوية المكتب البصرية', 'ZIP', 'التسويق', '2026-06-07'],
        ['محضر اجتماع Q2', 'PDF', 'الإدارة', '2026-06-05'],
        ['عقد صيانة سنوي', 'PDF', 'المشتريات', '2026-06-01'],
        ['خطة التدريب السنوية', 'XLSX', 'التدريب', '2026-05-30'],
        ['تقرير تدقيق داخلي', 'PDF', 'الجودة', '2026-06-04'],
        ['نموذج طلب إجازة', 'DOCX', 'الموارد البشرية', '2026-05-25'],
        ['شهادة اعتماد ISO', 'PDF', 'الإدارة', '2026-06-06']
      ]
    },
    'eo-archive': {
      title: 'الأرشيف',
      ...
      seed: [
        ...
        ['سجلات الموظفين 2024', 'الموارد البشرية', '2024', 'مؤمن'],
        ['فواتير 2025', 'المالية', '2025', 'مفهرس'],
        ['محاضر الاجتماعات', 'الإدارة', '2025', 'مؤمن'],
        ['خطط التدريب', 'التدريب', '2024', 'مفهرس'],
        ['عقود الموردين', 'المشتريات', '2025', 'بانتظار الفهرسة'],
        ['تقارير الجودة', 'الجودة', '2025', 'مؤمن'],
        ['مراسلات العملاء', 'خدمة العملاء', '2026', 'مفهرس']
      ]
    },
    'eo-tasks': {
      title: 'المهام',
      ...
      seed: [
        ...
        ['إعداد تقرير المبيعات', 'المبيعات', 'عالية', 'جارية'],
        ['تحديث سياسات التشغيل', 'الجودة', 'متوسطة', 'مجدولة'],
        ['متابعة تجديد الاشتراكات', 'إدارة الاشتراكات', 'عالية', 'جارية'],
        ['تدقيق صلاحيات المستخدمين', 'تقنية المعلومات', 'عالية', 'منجزة'],
        ['تجهيز عرض للعميل', 'المبيعات', 'متوسطة', 'جارية'],
        ['أرشفة مستندات Q1', 'الأرشيف', 'منخفضة', 'مجدولة'],
        ['تنسيق اجتماع الإدارة', 'السكرتارية', 'متوسطة', 'منجزة']
      ]
    },
    'eo-meetings': {
      title: 'الاجتماعات',
      ...
      seed: [
        ...
        ['اجتماع الموارد البشرية', 'مدير HR', '10:00', 'مجدول'],
        ['مراجعة الميزانية', 'المدير المالي', '14:00', 'مجدول'],
        ['لقاء العملاء الجدد', 'فريق المبيعات', '15:30', 'مجدول'],
        ['ورشة التدريب الداخلي', 'فريق التدريب', 'أمس', 'مكتمل'],
        ['اجتماع تقنية المعلومات', 'مدير IT', '13:00', 'مجدول'],
        ['لجنة المخاطر', 'إدارة المخاطر', '16:00', 'مجدول'],
        ['اجتماع الإدارة العليا', 'المدير التنفيذي', 'أمس', 'مكتمل']
      ]
    },
    'eo-consultations': {
      title: 'الاستشارات',
      ...
      seed: [
        ...
        ['3101', 'مصنع الخليج', 'consult@gulf-mfg.sa', '+966503101333', 'فرع الدمام', 'حاضنة الشرقية', 'منصة الشرقية', 'مكتب الدمام', 'تقييم سلامة', 'خبير سلامة', 'قيد الدراسة'],
        ['3105', 'مستشفى النور', 'quality@alnoor-hosp.sa', '+966503105444', 'فرع جدة', 'Safety Incubator', 'NAIOSH Cloud', 'مكتب جدة', 'اعتماد جودة', 'مستشار جودة', 'مجدولة'],
        ['3110', 'أكاديمية المستقبل', 'edu@future-ac.sa', '+966503110555', 'فرع الرياض', 'حاضنة الرياض', 'منصة الرياض', 'مكتب التدريب', 'تطوير منهج', 'خبير تعليم', 'قيد الدراسة'],
        ['3115', 'شركة النقل السريع', 'logistics@fastlog.sa', '+966503115666', 'فرع الدمام', '—', '—', 'مكتب اللوجستيات', 'تحسين سلسلة الإمداد', 'مستشار لوجستي', 'مجدولة'],
        ['3120', 'مجمع الأعمال الرقمي', 'strategy@dba-hub.sa', '+966503120777', 'فرع الرياض', 'حاضنة الرياض التقنية', 'منصة الرياض', 'مكتب المبيعات', 'استراتيجية نمو', 'مستشار أعمال', 'مغلقة'],
        ['3125', 'مؤسسة البناء الحديث', 'pm@modern-build.sa', '+966503125888', 'فرع جدة', 'حاضنة جدة', 'منصة جدة', 'مكتب جدة', 'إدارة مشاريع', 'خبير مشاريع', 'قيد الدراسة'],
        ['3130', 'تجمع الصحة الرقمية', 'digital@health-dx.sa', '+966503130999', 'المكتب الرئيسي', '—', '—', 'المكتب الرئيسي', 'تحول رقمي', 'مستشار تقني', 'مجدولة']
      ]
    },
    'eo-latest-news': {
      title: 'آخر الأخبار',
      ...
      seed: [
        ...
        ['تعميم بخصوص ساعات العمل', 'الموارد البشرية', '2026-06-06', 'منشور'],
        ['إعلان فتح باب التسجيل للدورات', 'التدريب', '2026-06-05', 'منشور'],
        ['تحديث نظام الفوترة', 'المالية', '2026-06-04', 'منشور'],
        ['مبادرة رضا العملاء', 'خدمة العملاء', '2026-06-02', 'منشور'],
        ['تعميم أمن المعلومات', 'تقنية المعلومات', '2026-05-30', 'مؤرشف'],
        ['إعلان نتائج Q1', 'الإدارة', '2026-05-28', 'مؤرشف'],
        ['افتتاح مكتب الدمام الجديد', 'الإدارة', '2026-06-09', 'منشور']
      ]
    },
    'eo-users': {
      title: 'المستخدمين',
      ...
      seed: [
        ...
        ['1004', 'مدير مبيعات', 'sales.mgr@naiosh.com', '+966501004000', 'فرع الرياض', 'حاضنة الرياض التقنية', 'منصة الرياض', 'مكتب المبيعات', 'مدير', 'نشط'],
        ['1005', 'محاسب', 'finance@naiosh.com', '+966501005000', 'فرع جدة', 'حاضنة جدة', 'منصة جدة', 'مكتب جدة', 'محاسب', 'نشط'],
        ['1006', 'منسق تدريب', 'training@naiosh.com', '+966501006000', 'فرع الدمام', 'حاضنة الشرقية', 'منصة الشرقية', 'مكتب الدمام', 'منسق', 'نشط'],
        ['1007', 'مشرف جودة', 'quality@naiosh.com', '+966501007000', 'المكتب الرئيسي', '—', '—', 'المكتب الرئيسي', 'مشرف', 'نشط'],
        ['1008', 'موظف أرشيف', 'archive@naiosh.com', '+966501008000', 'فرع الرياض', 'حاضنة الرياض', 'منصة الرياض', 'مكتب الأرشيف', 'موظف', 'نشط'],
        ['1009', 'مدير مشروع', 'pm@naiosh.com', '+966501009000', 'فرع جدة', 'Safety Incubator', 'NAIOSH Cloud', 'مكتب المشاريع', 'مدير', 'بانتظار التفعيل'],
        ['1010', 'محلل بيانات', 'analyst@naiosh.com', '+966501010000', 'فرع الدمام', '—', '—', 'مكتب التحليل', 'محلل', 'نشط']
      ]
    }
  };
  ...
  async function fetchRows(route) {
    ...
    try {
      ...
      } else if (records.length < SEED_MINIMUM) {
        await replenishModuleIfSparse(route, config);
        const replenishedPayload = await apiRequest(route);
        records = normalizeRecords(route, replenishedPayload.records || []);
      }
  ...
  function mountPage(route, records) {
    const view = document.getElementById('main-view');
    if (!view || window.currentAppRoute !== route) return false;
    const page = document.querySelector(`[data-eo-page="${route}"]`);
    if (page) {
      refreshPage(route, records);
      return true;
    }
    view.innerHTML = `<div class="fade-in" data-page-scope>${renderPage(route)}</div>`;
  ...
  window.EOfficesPages = {
    ...
    async init(route, expectedGeneration) {
      const config = PAGE_CONFIGS[route];
      if (!config) return;
      if (expectedGeneration != null && expectedGeneration !== window.loadRouteGeneration) return;
      ensureDelegation();
      const records = await fetchRows(route);
      if (window.currentAppRoute !== route) return;
      if (expectedGeneration != null && expectedGeneration !== window.loadRouteGeneration) return;
      saveLocalRows(route, records);
      mountPage(route, records);
      bindPageActions(route);
    }
  };
