/**
 * 🧪 Test AI Forecasts API Endpoints
 */
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                total_forecasts: data.summary?.total_forecasts,
                sum_forecast: data.summary?.sum_forecast,
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - التنبؤات الذكية');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/ai-forecasts/test`
    );
