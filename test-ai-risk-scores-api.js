/**
 * 🧪 Test AI Risk Scores API Endpoints
 */
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                total_scores: data.summary?.total_scores,
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - تقييم المخاطر الذكي');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/ai-risk-scores/test`
    );
