    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                active_customers: data.summary?.active_customers,
                blocked_customers: data.summary?.blocked_customers
            });
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - العملاء');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/customers/test`
    );
