    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                total_payments: data.summary?.total_payments,
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - المدفوعات');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/payments/test`
    );
    ...
    const test2 = await testAPI(
        '2️⃣ Get Payments',
        `${BASE_URL}/finance/payments?entity_id=${ENTITY_ID}`
    );
