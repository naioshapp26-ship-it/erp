/**
 * 🧪 Test Cashflow Summary API Endpoints
 */
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - ملخص التدفقات النقدية');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/cashflow-summary/test`
    );
    ...
    const test2 = await testAPI(
        '2️⃣ Get Cashflow Summary',
        `${BASE_URL}/finance/cashflow-summary?entity_id=${ENTITY_ID}`
    );
