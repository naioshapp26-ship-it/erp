    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(`📊 Data Summary:`, {
                ...
                total_vendors: data.summary?.total_vendors,
...
async function runAllTests() {
    ...
    console.log('🧪 اختبار Backend API - المصروفات والموردون');
    console.log('='.repeat(80));
    ...
    const test1 = await testAPI(
        ...
        `${BASE_URL}/finance/expenses/test`
    );
    ...
    const test2 = await testAPI(
        '2️⃣ Get Expenses Report',
        `${BASE_URL}/finance/expenses?entity_id=${ENTITY_ID}`
    );
