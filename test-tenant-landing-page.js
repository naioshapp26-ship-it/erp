...
const checks = [
  ...
  ['hero follows branding primary', landing.includes("hero.style.setProperty('background', primary, 'important')") && !landing.includes('Reject magenta/purple-leaning secondary')],
