...
async function testElectronicSignatureAPI() {
    console.log('🧪 اختبار واجهات التوقيع الإلكتروني\n');
    ...
    if (passedTests === tests.length) {
        console.log('🎉 جميع اختبارات التوقيع الإلكتروني نجحت!\n');
        process.exit(0);
    } else {
